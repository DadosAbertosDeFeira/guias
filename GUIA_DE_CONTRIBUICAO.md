...
ou no nosso [Discord](https://discord.gg/Te5wnyzveZ) e participe das discussões.
...
- Os projetos são um conjunto de funcionalidades e melhorias que queremos desenvolver em cada repositório.
Caso não tenha nada que seja a sua praia, você pode dar uma olhada nos
[projetos gerais](https://github.com/orgs/DadosAbertosDeFeira/projects) ou no Trello (próxima seção).
...
* Atualize o `README.md` com os detalhes da mudança caso esta inclua uma nova base de dados
ou um novo comando na CLI.
